...
def parse_args():
    ...
    # model args
    parser.add_argument("--model_type", default='WaveRec', type=str)
    ...
    if args.model_type.lower() == 'waverec':
        parser.add_argument("--pass_weight", default=1.0, type=float)
        parser.add_argument("--alpha", default=0.5, type=float)
        parser.add_argument("--filter_type", default="haar", type=str)
        parser.add_argument("--filter_length", default=16, type=int)
